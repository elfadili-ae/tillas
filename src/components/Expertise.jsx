...
const Expertise = () => {
    return (
        <section id='expertise' className='relative w-full min-h-screen bg-black border-t-2 border-t-purple-400 overflow-hidden'>
            ...
            <div className='w-full h-full flex flex-col mt-16 md:mt-24 mb-24'>
                <Link href='/portfolio-details' className='group relative w-full h-20 flex flex-col justify-center items-center text-slate-600 hover:text-purple-200 hover:bg-gradient-to-b hover:from-fuchsia-300 transition-all ease-in-out duration-75 hover:to-violet-500 md:h-40 border-b-2 border-slate-600 py-3'>
                ...
                <Link href='/portfolio-details' className='group relative w-full h-20 flex flex-col justify-center items-center text-slate-600 hover:text-purple-200 hover:bg-gradient-to-b hover:from-violet-400 transition ease-in-out delay-75 hover:to-violet-700 md:h-40 border-b-2 border-slate-600 py-3'>
                ...
                <Link href='/portfolio-details' className='group relative w-full h-20 flex flex-col justify-center items-center text-slate-600 hover:text-purple-200 hover:bg-gradient-to-b hover:from-violet-500 transition ease-in-out delay-75 hover:to-violet-900 md:h-40 border-b-2 border-slate-600 py-3'>
                ...
                <Link href='/portfolio-details' className='group relative w-full h-20 flex flex-col justify-center items-center text-slate-600 hover:text-purple-200 hover:bg-gradient-to-b hover:from-violet-900 transition ease-in-out delay-75 hover:to-fuchsia-600 md:h-40 border-b-2 border-slate-600 py-3'>
