...
const ProjectCard = ({ pic1, pic2, name1, name2, flip }) => {
    return (
        <div className={`flex gap-8 flex-col ${flip ? 'md:flex-row-reverse' : 'md:flex-row'} justify-around items-center`}>
            <Link href='/portfolio-details' className='flex w-fit h-fit flex-col items-between justify-center gap-4 bg-slate-800 p-6 border-2 border-purple-200 hover:border-purple-600'>
            ...
            <Link href='/portfolio-details' className='flex w-full md:max-w-[420px] md:aspect-square flex-col items-center justify-center gap-4 bg-slate-800 p-6 border-2 border-purple-200 hover:border-purple-600'>
